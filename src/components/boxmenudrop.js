    ...
    <div className="dropdown" onClick={handleToggle} ref={wrapperRef}>
      ...
      >
        <div className="drop-item">
          ...
          <Link  className="drop-link" to="/chat">
            <img
              src={img}
              alt=""
            />
          ...
          <a className="drop-link" href="https://drive.google.com/file/d/1AGFiyvBi1pg639p5iKB2lgGoPr4JL5tE/view?usp=sharing">
            <img
              src={news}
              alt=""
            />
          ...
          <a className="drop-link" href="mailto:gandhi.ketan55555@gmail.com">
            <img
              src={email}
              alt=""
            />
          ...
          <a className="drop-link" href="https://github.com/ketanspage">
            <img
              src={gh}
              alt=""
            />
          ...
          <a className="drop-link" href="https://www.linkedin.com/in/ketan-gandhi-68840821b/">
            <img
              src={li}
              alt=""
            />
